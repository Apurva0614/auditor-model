...
class Router:
    ...
    The router queries the primary model for predictions and the auditor for
    suppression decisions, then combines them into a routing result.

    Args:
        primary_model: A fitted PrimaryModel instance.
